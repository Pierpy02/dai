...
function animazione_pushdown_separata(t1, P1_1, P2_1, P3_1, theta1_1, theta2_1, J1, tau1, ...
    ...
    set(ax1, 'Position', [pos1(1)-0.08, pos1(2)-0.09, pos1(3)*1.5, pos1(4)*1.15]);
    set(ax2, 'Position', [pos2(1)-0.34, pos2(2)-0.09, pos2(3)*1.5, pos2(4)*1.15])


    pos3 = get(ax3,'Position'); pos4 = get(ax4,'Position');
    set(ax3,'Position',[pos3(1)+0.05, pos3(2)-0.05, pos3(3)-0.05, pos3(4)]);
    set(ax4,'Position',[pos4(1)-0.07, pos4(2)-0.05, pos4(3)-0.05, pos4(4)]);
